defmodule OthelloWeb.UserControllerTest do
  use OthelloWeb.ConnCase

  alias Othello.Accounts

  @create_attrs %{email: "some email", last_session: "2010-04-17 14:00:00.000000Z", name: "some name", password: "some password", pwd_tries: 42}
